    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="relative mb-8">
          <h1
            className={`text-9xl md:text-[200px] font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 select-none transition-all duration-200 ${
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          ...
          >
            <span className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-400 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
