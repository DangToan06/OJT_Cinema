...
export function TheatersManagement() {
  ...
  const StatusButton = ({ status, onToggle }: StatusButtonProps) => {
    return (
      <button
        onClick={onToggle}
        className="px-2 bg-gray-700 w-fit backdrop-blur-sm hover:bg-gray-600 text-purple-400 rounded-lg transition-all hover:scale-110 shadow-lg cursor-pointer"
        title="Đổi trạng thái"
      >
        {status === "Đang hoạt động" ? (
          <ToggleRight size={25} className="text-purple-400" />
        ) : (
    ...
    <div className="p-8 min-h-screen bg-gray-900">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="flex items-center cursor-pointer gap-2 bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700 transition-colors shadow-lg shadow-red-900/30"
        >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {dataTheaters.theaters.map((theater) => (
          <div
            key={theater.id}
            className="group bg-gray-900 rounded-2xl shadow-lg border border-gray-800 hover:border-gray-700 transition-all duration-300 overflow-hidden"
          >
            <div className="p-5 bg-gradient-to-r from-purple-800 to-indigo-900 flex justify-between items-start">
              <div>
                <h3 className="text-white text-2xl font-bold mb-3 pr-4">
                  {theater.name}
                </h3>
              ...
              <div className="h-fit flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <button className="p-2 bg-gray-700 hover:bg-gray-600 text-blue-400 rounded-lg transition-all hover:scale-110 shadow-lg cursor-pointer">
                  <Edit className="w-5 h-5" />
                </button>

                <button
                  className="p-2 bg-gray-700 hover:bg-gray-600 text-red-400 rounded-lg transition-all hover:scale-110 shadow-lg cursor-pointer"
            ...
            <div className="p-4 px-6 pb-4">
              <div className="space-y-2">
                <div className="flex items-start gap-3 group/item py-2 rounded-lg transition-colors hover:bg-gray-800/50">
                  <div className="p-2 bg-indigo-900/30 rounded-lg text-indigo-400 group-hover/item:text-indigo-300 transition-colors">
                ...
                <div className="flex items-start gap-3 group/item py-2 rounded-lg transition-colors hover:bg-gray-800/50">
                  <div className="p-2 bg-emerald-900/30 rounded-lg text-emerald-400 group-hover/item:text-emerald-300 transition-colors">
                ...
                <div className="flex items-start gap-3 group/item py-2 rounded-lg transition-colors hover:bg-gray-800/50">
                  <div className="p-2 bg-blue-900/30 rounded-lg text-blue-400 group-hover/item:text-blue-300 transition-colors">
                    <Globe className="w-5 h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-xs text-gray-400 mb-0.2">Website</p>
                    <a
                      href={`https://${theater.website}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-sm text-yellow-500 hover:text-yellow-400 font-medium hover:underline"
                    >
                      {theater.website}
                    </a>
                  </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-700">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 text-gray-300">
                    ...
                    <span className="text-[15px] font-medium">Phòng chiếu</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[15px] text-gray-400">phòng</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div
              className="sticky top-0 bg-gradient-to-r from-purple-800 to-indigo-900 
                      text-white p-4 rounded-t-2xl flex items-center justify-between border-b border-gray-700"
            >
              <div>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className={labelClass}>
                    Số Phòng Chiếu <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="number"
                    name="screens"
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-700">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-700 to-indigo-700
      ...
      {isDeleteModalOpen && theaterToDelete && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl shadow-2xl w-full max-w-md">
            <div className="bg-gradient-to-r from-red-800 to-red-900 text-white p-6 rounded-t-2xl border-b border-red-900">
